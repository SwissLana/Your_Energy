import{a as p,i as u}from"./vendor-CaULtfQf.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();const P="https://your-energy.b.goit.study/api",de={MUSCLES:"Muscles",BODY_PARTS:"Body parts",EQUIPMENT:"Equipment"},q="your-energy-favorites",C="your-energy-quote";p.defaults.baseURL=P;async function ue(e,t,a){return(await p.get("/filters",{params:{filter:e,page:t,limit:a}})).data}async function fe(e){return(await p.get("/exercises",{params:e})).data}async function A(e){return(await p.get(`/exercises/${e}`)).data}async function U(){return(await p.get("/quote")).data}async function pe(e){return(await p.post("/subscription",{email:e})).data}async function _(e,t){return(await p.patch(`/exercises/${e}/rating`,t)).data}function Q(e){return/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/.test(e)}function ge(){return window.innerWidth<768?8:10}function D(e,t){return(JSON.parse(localStorage.getItem("ratedExercises"))||[]).some(s=>s.exerciseId===e&&s.email===t)}function J(e,t){const a=JSON.parse(localStorage.getItem("ratedExercises"))||[];a.push({exerciseId:e,email:t}),localStorage.setItem("ratedExercises",JSON.stringify(a))}const c="/Your_Energy/assets/sprite-DgNJrWnb.svg";function L(){return JSON.parse(localStorage.getItem(q))||[]}function M(e){localStorage.setItem(q,JSON.stringify(e))}function z(e){const t=L();t.some(a=>a===e)||(t.push(e),M(t))}function Y(e){const t=L().filter(a=>a!==e);M(t)}function F(e){return L().some(t=>t===e)}function H(e){const t=new Date().toISOString().split("T")[0];localStorage.setItem(C,JSON.stringify({date:t,quote:e}))}function K(){const e=JSON.parse(localStorage.getItem(C));if(!e)return null;const t=new Date().toISOString().split("T")[0];return e.date===t?e.quote:null}function j({name:e,filter:t,imgURL:a}){return`
  ...
  `}function ve(e){return e.map(j).join("")}function V(e,t={}){const a=typeof t=="boolean"?t:(t==null?void 0:t.isFavorite)??!1,{_id:s,name:r,rating:n,burnedCalories:i,bodyPart:m,target:h}=e,N=a?`
        <button
  ...
  `}function me(e){return e.map(t=>V(t,!1)).join("")}function w(e){return typeof e=="string"&&e.length>0?e.charAt(0).toUpperCase()+e.slice(1):e}function W(e){const{_id:t,name:a,burnedCalories:s,bodyPart:r,target:n}=e,i=w(r),m=w(n),h=`${s} / 3 min`;return`
  ...
  `}function he(e){return e.map(W).join("")}function G(e){const t=F(e._id),a=Z(e.rating),s=t?"Remove from favorites":"Add to favorites",r=t?"icon-trash":"icon-heart";return`
