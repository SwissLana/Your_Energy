import{a as f,i as d}from"./vendor-CaULtfQf.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=a(r);fetch(r.href,i)}})();const _="https://your-energy.b.goit.study/api",de={MUSCLES:"Muscles",BODY_PARTS:"Body parts",EQUIPMENT:"Equipment"},k="your-energy-favorites",q="your-energy-quote",ue=10,fe=12;f.defaults.baseURL=_;async function ge(e,t,a){return(await f.get("/filters",{params:{filter:e,page:t,limit:a}})).data}async function pe(e){return(await f.get("/exercises",{params:e})).data}async function A(e){return(await f.get(`/exercises/${e}`)).data}async function N(){return(await f.get("/quote")).data}async function ve(e){return(await f.post("/subscription",{email:e})).data}async function U(e,t){return(await f.patch(`/exercises/${e}/rating`,t)).data}const m="/Your_Energy/assets/sprite-BXuv3VU9.svg";function $(){return JSON.parse(localStorage.getItem(k))||[]}function M(e){localStorage.setItem(k,JSON.stringify(e))}function Q(e){const t=$();t.some(a=>a===e)||(t.push(e),M(t))}function D(e){const t=$().filter(a=>a!==e);M(t)}function R(e){return $().some(t=>t===e)}function J(e){const t=new Date().toISOString().split("T")[0];localStorage.setItem(q,JSON.stringify({date:t,quote:e}))}function z(){const e=JSON.parse(localStorage.getItem(q));if(!e)return null;const t=new Date().toISOString().split("T")[0];return e.date===t?e.quote:null}function Y({name:e,filter:t,imgURL:a}){return`
  ...
  `}function me(e){return e.map(Y).join("")}function G(e,t={}){const a=typeof t=="boolean"?t:(t==null?void 0:t.isFavorite)??!1,{_id:s,name:r,rating:i,burnedCalories:n,bodyPart:b,target:y}=e,I=a?`
        <button
  ...
  `}function he(e){return e.map(t=>G(t,!1)).join("")}function w(e){return typeof e=="string"&&e.length>0?e.charAt(0).toUpperCase()+e.slice(1):e}function K(e){const{_id:t,name:a,burnedCalories:s,bodyPart:r,target:i}=e,n=w(r),b=w(i),y=`${s} / 3 min`;return`
  ...
  `}function be(e){return e.map(K).join("")}function V(e){const t=R(e._id),a=j(e.rating),s=t?"Remove from favorites":"Add to favorites",r=t?"icon-trash":"icon-heart";return`
  ...
  `}function j(e){const a=Number(e||0);let s="";const r=Math.round(a%1*100);s+=`
